...
At Least 8 Characters with uppercase & lower case</p>
                        ...
                        <input type="password" placeholder='Enter New Password' className='mt-8 py-3 outline-none px-2 border border-gray-200 rounded-md' />

                        <input type="password" placeholder='Confirm New Password' className='mt-8 py-3 outline-none px-2 border border-gray-200 rounded-md' />

                        <div className='flex items-center justify-center'>
                            <button className='bg-darkBlue mt-8 text-white px-8 py-3 rounded-md font-medium '>Reset Password</button>
                        </div>
                    </form>
                </div>
