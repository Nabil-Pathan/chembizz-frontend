      ...
      <div className='p-10 flex md:flex-row flex-col bg-white rounded-2xl'>
        ...
        <div className='p-10 md:w-[70%] flex flex-col items-center justify-center md:h-[700px] rounded-2xl'>
          <form className='flex flex-col  '>
            ...
            <span className='text-darkBlue mt-6'><Link to="/forgot-password">Forgot Password ?</Link> </span>
            <div className='flex items-center justify-center'>
              <button className='bg-darkBlue mt-8 text-white px-8 py-3 rounded-md font-medium'>Login</button>
            </div>
          </form>
        </div>
